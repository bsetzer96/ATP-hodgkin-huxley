...
g_GABA_fs=1/(m-1)
g_M=2
I_app_py= 2.8 #1.8 #3.4       #applied current to pyramidal cells
...
y_fs=y[6*n:(7*n+4*m),:] #extracting fs cell states
...
Sxx = Sxx[:int(len(lfs) / 2)]  # Ignore negative frequencies

df = 1 / N  # Determine frequency resolution
